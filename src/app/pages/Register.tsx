    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-50 to-stone-50 flex items-center justify-center px-4 py-16">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-stone-500 text-sm">Guarda tus pedidos y deja reseñas</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm text-stone-600 mb-1.5 font-medium">Nombre completo</label>
            <input
              type="text"
              value={name}
          ...
          <div>
            <label className="block text-sm text-stone-600 mb-1.5 font-medium">
        ...
        <div className="mt-6 text-center space-y-3">
          <p className="text-stone-500 text-sm">
            ¿Ya tienes cuenta?{" "}
            <Link to="/login" className="text-rose-600 hover:text-rose-700 font-medium transition-colors">
              Inicia sesión
            </Link>
          </p>
          <Link
